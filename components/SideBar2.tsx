...
function SideBar2({menu}: SideBar2Props) {
    const router = useRouter();

    function logoutConfirm() {
        if(confirm("로그아웃을 실행합니다.")){
            googleLogout();
        }
    }
                ...
                <aside className="lnb" id="lnb" data-name="Property 1=LNB 240" data-node-id="179:7127">
                    ...
                    <div className="lnb-content" data-name="Content">
                        ...
                        <nav className="lnb-menu" data-name="list">
                            <a href="#dashboards"
                               className={`lnb-menu-item ${menu == 'dashboard' ? 'lnb-menu-item-active' : ''}`}
                               data-node-id="244:10706" onClick={() => router.push('/dashboard')}>
                            ...
                            <a href="#jupyter-settings"
                               className={`lnb-menu-item ${menu == 'setting' ? 'lnb-menu-item-active' : ''}`}
                               data-node-id="244:11275" onClick={() => router.push('/setting')}>
